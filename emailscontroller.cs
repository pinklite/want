...
namespace webmail_server.Controllers
{
    ...
    public class EmailsController : Controller
    {
        ...
        public IEnumerable Init(int id)
        {
        ...
        // GET: api/Emails/5
        [HttpGet("{id}")]
        public async Task GetEmail([FromRoute] int id)
        {
        ...
        // PUT: api/Emails/5
        [HttpPut("{id}")]
        public async Task PutEmail([FromRoute] int id, [FromBody] Email email)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        // POST: api/Emails
        [HttpPost]
        public async Task PostEmail([FromBody] Email email)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        // DELETE: api/Emails/5
        [HttpDelete("{id}")]
        public async Task DeleteEmail([FromRoute] int id)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
